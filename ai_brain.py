...
- تغيير اللغة من إعدادات الحساب

تنزيل التطبيق:
- افتح رابط المنصة في Chrome
- اضغط على النقاط الثلاث
- اختر إضافة إلى الشاشة الرئيسية

تغيير كلمة المرور:
- التواصل مع المشرف المباشر خلال ساعات الدوام

════════════════════

تذكر: إذا كنت لا تعرف الإجابة قل: للتفاصيل الدقيقة يرجى التواصل مع مديرك المباشر.
